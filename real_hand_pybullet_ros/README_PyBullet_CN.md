...
# 1.1 **Notes**
This program provides a PyBullet simulation environment for the RealHand series of dexterous hands, making it convenient for users to become familiar with how to use RealHand dexterous hand products, and to perform model training and data collection in a simulation environment.

# 2. **Usage Instructions**
```bash
$ mkdir -p Real_Hand_Pybullet_ros/src    # create directory
$ cd Real_Hand_Pybullet_ros/src    # enter directory
...
$ git sparse-checkout set real_hand_pybullet_ros
$ cd Real_Hand_Pybullet_ros/src/real_hand_sim/
$ pip install -r requirements.txt # install dependencies
$ cd Real_Hand_Pybullet_ros/src/real_hand_sim/real_hand_pybullet_ros/scripts/
$ sudo chmod a+x real_hand_pybullet.py
```

- Start the PyBullet simulation
```bash
$ cd Real_Hand_Pybullet_ros/
$ catkin_make
$ source ./devel/setup.bash
$ rosrun real_hand_pybullet_ros real_hand_pybullet.py _hand_type:=L10  # change L10 to the desired hand model: L7, L10, L20, L21
```
