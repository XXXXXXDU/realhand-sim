...
class MujocoNode(Node):
    def __init__(self):
        super().__init__('real_hand_mujoco_ros2_node')
        ...
        XML_PATH = str(files("realhand_sim_shared").joinpath("muj_urdf", self.hand_joint.upper(), f"real_hand_{self.hand_joint.lower()}_{self.hand_type}", f"real_hand_{self.hand_joint.lower()}_{self.hand_type}.xml"))
