...
rospy.init_node('real_hand_mujoco')
...
XML_PATH = str(files("realhand_sim_shared").joinpath("muj_urdf", hand_joint.upper(), f"real_hand_{hand_joint.lower()}_{hand_type}", f"real_hand_{hand_joint.lower()}_{hand_type}.xml"))
